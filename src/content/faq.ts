...
export const faq: FaqItem[] = [
  {
    pergunta: "O que é o Comitê Paulo Gustavo Maranhão?",
    resposta:
  ...
  },
  {
    ...
    resposta:
      "O Comitê reúne em comitepaulogustavo.ma/editais os editais abertos do Estado do Maranhão (SECULT-MA) e do município de São Luís (Secretaria Municipal de Cultura), com link direto para a publicação oficial de cada um. A lista completa e sempre atualizada também pode ser conferida direto na SECULT-MA e na Prefeitura de São Luís.",
  },
  {
  ...
  },
  {
    ...
    resposta:
      "É o cadastro de fazedores e fazedoras de cultura do Comitê Paulo Gustavo Maranhão. Quem entra no Radar Cultural passa a ser indicado a produtores e curadores e recebe aviso de editais da sua linguagem artística e do seu município, em comitepaulogustavo.ma/radar-cultural.",
  },
  {
    pergunta: "Como participar do Comitê Paulo Gustavo Maranhão?",
    resposta:
